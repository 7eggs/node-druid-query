...
Query.required(TimeseriesQuery, 'granuality', 'aggregations', 'intervals')
Query.addFields(TimeseriesQuery, ['granuality', 'filter', 'aggregations', 'postAggregations', 'intervals', 'context'])