...
Query.required(GroupByQuery, 'dimensions', 'granuality', 'aggregations', 'intervals')
Query.addFields(GroupByQuery, ['granuality', 'dimensions', 'limitSpec', 'filter', 'aggregations', 'postAggregations', 'intervals', 'having', 'context'])