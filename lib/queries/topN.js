...
Query.required(TopNQuery, 'dimension', 'threshold', 'metric', 'granuality', 'aggregations', 'intervals')
Query.addFields(TopNQuery, ['dimension', 'threshold', 'metric', 'granuality', 'filter', 'aggregations', 'postAggregations', 'intervals'])